...
public class iHM {
	...
	/**
	 * @wbp.nonvisual location=430,211
	 */
	...
	private void initialize(String n) {
		...
		JButton btnChangerCoulour = new JButton("Changer Coulour");
		btnChangerCoulour.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
		...
		gl_panel.setHorizontalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_panel.createSequentialGroup()
					.addGap(44)
					.addComponent(btnChangerCoulour)
